...
/**
  ...
  */
final class SlidingWindowFunctionFrame(target: InternalRow,
...
/**
  ...
  * @param processor to calculate the row values with.
  */
final class UnboundedWindowFunctionFrame(target: InternalRow,
                                         processor: AggregateDirectProcessor)
    extends WindowFunctionFrame {
...
/**
  ...
  * @param ubound comparator used to identify the upper bound of an output row.
  */
final class UnboundedPrecedingWindowFunctionFrame(target: InternalRow,
                                                  processor: AggregateDirectProcessor,
                                                  ubound: DirectBoundOrdering)
    extends WindowFunctionFrame {
...
/**
  ...
  * @param lbound comparator used to identify the lower bound of an output row.
  */
final class UnboundedFollowingWindowFunctionFrame(target: InternalRow,
                                                  processor: AggregateDirectProcessor,
                                                  lbound: DirectBoundOrdering)
    extends WindowFunctionFrame {
